...
function revslider_showDoubleJqueryError(a) {
  ...
  !(function (a, b) {
    ...
    function d(d, e) {
      ...
      if (
        (d.data("aimg") != b &&
          (("enabled" == d.data("aie8") && i(8)) ||
            ("enabled" == d.data("amobile") && W())) &&
          d.html(
            '<img class="tp-slider-alternative-image" src="' +
              d.data("aimg") +
              '">'
          ),
        ("preview1" == e.navigationStyle ||
          "preview3" == e.navigationStyle ||
          "preview4" == e.navigationStyle) &&
          ((e.soloArrowLeftHalign = "left"),
        ...
        (e.desktop = !navigator.userAgent.match(
        ...
        "on" == e.fullWidth &&
          "off" == e.autoHeight &&
          d.css({ maxHeight: e.startheight + "px" }),
        W() &&
          "on" == e.hideThumbsOnMobile &&
          "thumb" == e.navigationType &&
          (e.navigationType = "none"),
        W() &&
          "on" == e.hideBulletsOnMobile &&
          "bullet" == e.navigationType &&
          (e.navigationType = "none"),
        W() &&
          "on" == e.hideBulletsOnMobile &&
          "both" == e.navigationType &&
          (e.navigationType = "none"),
        W() && "on" == e.hideArrowsOnMobile && (e.navigationArrows = "none"),
        "on" == e.forceFullWidth &&
          0 == d.closest(".forcefullwidth_wrapper_tp_banner").length)
      ) {
      ...
      try {
        e.hideThumbsUnderResolution > a(window).width() &&
        0 != e.hideThumbsUnderResolution
          ? d.parent().find(".tp-bullets.tp-thumbs").css({ display: "none" })
          : d.parent().find(".tp-bullets.tp-thumbs").css({ display: "block" });
      } catch (r) {}
      if (!d.hasClass("revslider-initialised")) {
        d.addClass("revslider-initialised"),
          d.attr("id") == b &&
            d.attr("id", "revslider-" + Math.round(1e3 * Math.random() + 5)),
          (e.firefox13 = !1),
        ...
        parseFloat(t[2] || "0"),
          ...
          W() &&
            d.find(".tp-caption").each(function () {
              var b = a(this);
              (1 == b.data("autoplayonlyfirsttime") ||
                "true" == b.data("autoplayonlyfirsttime")) &&
                b.data("autoplayonlyfirsttime", "false"),
                (1 == b.data("autoplay") || "true" == b.data("autoplay")) &&
                  b.data("autoplay", !1);
            });
        var x = 0,
          y = 0,
        ...
        if (
            ...
            try {
              if (
                ...
                a("head")
                  .find("*")
                  .each(function () {
                    a(this).attr("src") == e + "://www.youtube.com/iframe_api" &&
                      (g = !1);
                  }),
            ...
            try {
              if (
                ...
                a("head")
                  ...
                  .each(function () {
                    a(this).attr("src") ==
                      B + "://a.vimeocdn.com/js/froogaloop2.min.js" && (g = !1);
                  }),
          ...
          for (var E = 0; E < d.find(">ul:first-child >li").length; E++) {
            var F = Math.round(
              Math.random() * d.find(">ul:first-child >li").length
            );
            d.find(">ul:first-child >li:eq(" + F + ")").prependTo(
              d.find(">ul:first-child")
            );
          }
        ...
        (e.firststart = 1),
          ...
          0 == d.find(".tp-bannertimer").length &&
            d.append(
              '<div class="tp-bannertimer" style="visibility:hidden"></div>'
            );
        var J = d.find(".tp-bannertimer");
        if (
          (J.length > 0 && J.css({ width: "0%" }),
          ...
          (e.startheight == b || 0 == e.startheight) &&
            (e.startheight = d.height()),
          (e.width = d.width()),
          (e.height = d.height()),
          (e.bw = e.startwidth / d.width()),
          (e.bh = e.startheight / d.height()),
          e.width != e.startwidth &&
            ((e.height = Math.round(e.startheight * (e.width / e.startwidth))),
            d.height(e.height)),
          0 != e.shadow)
        ) {
          d.parent().append(
            '<div class="tp-bannershadow tp-shadow' + e.shadow + '"></div>'
          );
          var j = 0;
          "on" == e.forceFullWidth &&
            (j = 0 - e.container.parent().offset().left),
            d.parent().find(".tp-bannershadow").css({ width: e.width, left: j });
        }
        d.find("ul").css({ display: "none" }),
          d.find("ul").css({ display: "block" }),
          s(d, e),
        ...
        a(window).on(L, function () {
          ...
          if (0 != a("body").find(d) && "on" == e.forceFullWidth) {
            ...
            e.container
              .parent()
              .css({ left: 0 - c + "px", width: a(window).width() });
          }
          (d.outerWidth(!0) != e.width || d.is(":hidden")) && h(d, e);
        });
        try {
          0 != e.hideThumbsUnderResoluition &&
            "thumb" == e.navigationType &&
            (e.hideThumbsUnderResoluition > a(window).width()
              ? a(".tp-bullets").css({ display: "none" })
              : a(".tp-bullets").css({ display: "block" }));
        } catch (r) {}
        ...
        var M = d.parent();
        a(window).width() < e.hideSliderAtLimit &&
          (d.trigger("stoptimer"),
    ...
    a.fn.extend({
      ...
      revscroll: function (c) {
        return this.each(function () {
          ...
          d != b &&
            d.length > 0 &&
            a("body").find("#" + d.attr("id")).length > 0 &&
            a("body,html").animate(
              {
      ...
      revredraw: function () {
        return this.each(function () {
          ...
          if (
            c != b &&
            c.length > 0 &&
            a("body").find("#" + c.attr("id")).length > 0
          ) {
      ...
      revkill: function () {
        ...
        if (
          e != b &&
          e.length > 0 &&
          a("body").find("#" + e.attr("id")).length > 0
        ) {
          e.data("conthover", 1),
      ...
      revnext: function () {
        return this.each(function () {
          ...
          c != b &&
            c.length > 0 &&
            a("body").find("#" + c.attr("id")).length > 0 &&
            c.parent().find(".tp-rightarrow").click();
        });
      },
      revprev: function () {
        return this.each(function () {
          ...
          c != b &&
            c.length > 0 &&
            a("body").find("#" + c.attr("id")).length > 0 &&
            c.parent().find(".tp-leftarrow").click();
        });
      },
      ...
      revshowslide: function (c) {
        return this.each(function () {
          ...
          d != b &&
            d.length > 0 &&
            a("body").find("#" + d.attr("id")).length > 0 &&
            (d.data("showus", c), d.parent().find(".tp-rightarrow").click());
        });
      },
    }),
      (function () {
    ...
    var f = function (c, d) {
      ...
      h = function (c, d) {
        if (c == b) return !1;
        try {
          0 != d.hideThumbsUnderResoluition &&
            "thumb" == d.navigationType &&
            (d.hideThumbsUnderResoluition > a(window).width()
              ? a(".tp-bullets").css({ display: "none" })
              : a(".tp-bullets").css({ display: "block" }));
        } catch (e) {}
        ...
        var f = c.parent();
        a(window).width() < d.hideSliderAtLimit
          ? (c.trigger("stoptimer"),
            "none" != f.css("display") && f.data("olddisplay", f.css("display")),
            f.css({ display: "none" }))
          : c.is(":hidden") &&
            (f.data("olddisplay") != b &&
            "undefined" != f.data("olddisplay") &&
            "none" != f.data("olddisplay")
              ? f.css({ display: f.data("olddisplay") })
              : f.css({ display: "block" }),
        ...
        v(c, d, c),
          ...
          i.find(".defaultimg").css({ opacity: 1 }),
          j.find(".defaultimg").each(function () {
            var e = a(this);
            "on" == d.panZoomDisableOnMobile ||
              (e.data("kenburn") != b &&
                (e.data("kenburn").restart(), Y(c, d, !0)));
          });
        var k = c.find(">ul >li:eq(" + d.next + ")"),
          l = c.parent().find(".tparrows");
        l.hasClass("preview2") &&
          l.css({ width: parseInt(l.css("minWidth"), 0) }),
          L(k, d, !0),
          p(c, d);
      },
      i = function (b, c) {
      ...
      j = function (a, b) {
        a.next == b.find(">ul >li").length - 1 &&
          ((a.looptogo = a.looptogo - 1), a.looptogo <= 0 && (a.stopLoop = "on")),
          z(b, a);
      },
      k = function (b, c) {
        var d = "hidebullets";
        0 == c.hideThumbs && (d = ""),
          ("bullet" == c.navigationType || "both" == c.navigationType) &&
            b
              .parent()
              .append(
          ...
          e.find(".bullet").each(function (d) {
            ...
            d == c.slideamount - 1 && e.addClass("last"),
              ...
              e.click(function () {
                var a = !1,
                  d = e.index();
                ("withbullet" == c.navigationArrows ||
                  "nexttobullets" == c.navigationArrows) &&
                  (d = e.index() - 1),
                  d == c.act && (a = !0),
                  0 != c.transition || a || ((c.next = d), j(c, b));
              });
          }),
        ...
        0 == c.hideThumbs && (f = ""),
          ...
          a
            ...
            .click(function () {
              0 == c.transition &&
                ((c.next =
                  a.data("showus") != b && -1 != a.data("showus")
                    ? a.data("showus") - 1
                    : c.next + 1),
                a.data("showus", -1),
      ...
      m = function (c, d) {
        a(document).keydown(function (a) {
          0 == d.transition &&
            39 == a.keyCode &&
            ((d.next =
              c.data("showus") != b && -1 != c.data("showus")
                ? c.data("showus") - 1
                : d.next + 1),
            c.data("showus", -1),
      ...
      n = function (b, c) {
        var d = "vertical";
        "on" == c.touchenabled &&
          (1 == c.drag_block_vertical && (d = "none"),
          b.swipe({
            allowPageScroll: d,
      ...
      o = function (a, b) {
        ...
        if (
          (a.data("hideThumbs", b.hideThumbs),
      ...
      p = function (b, c) {
        ...
        "thumb" == c.navigationType &&
          "nexttobullets" == c.navigationArrows &&
          (c.navigationArrows = "solo"),
          "nexttobullets" == c.navigationArrows &&
            (g.prependTo(e).css({ float: "left" }),
            h.insertBefore(e.find(".tpclear")).css({ float: "left" }));
        var i = 0;
        "on" == c.forceFullWidth && (i = 0 - c.container.parent().offset().left);
        var j = 0,
          k = 0;
        if (
          ("on" == c.navigationInGrid &&
            ((j = b.width() > c.startwidth ? (b.width() - c.startwidth) / 2 : 0),
            (k =
              b.height() > c.startheight ? (b.height() - c.startheight) / 2 : 0)),
          ...
          g.css({ position: "absolute" }),
            ...
            "center" == l
              ...
              : "bottom" == l
              ? g.css({ top: "auto", bottom: 0 + p + "px" })
              : "top" == l && g.css({ bottom: "auto", top: 0 + p + "px" }),
            "center" == m
              ? g.css({
                  left: "50%",
            ...
            "center" == n
              ...
              : "bottom" == n
              ? h.css({ top: "auto", bottom: 0 + r + "px" })
              : "top" == n && h.css({ bottom: "auto", top: 0 + r + "px" }),
            "center" == o
              ? h.css({
                  left: "50%",
              ...
              : "left" == o
              ? h.css({ left: j + s + i + "px" })
              : "right" == o && h.css({ right: j + s - i + "px" }),
            null != g.position() &&
              g.css({ top: Math.round(parseInt(g.position().top, 0)) + "px" }),
            null != h.position() &&
              h.css({ top: Math.round(parseInt(h.position().top, 0)) + "px" });
        }
        "none" == c.navigationArrows &&
          (g.css({ visibility: "hidden" }), h.css({ visibility: "hidden" }));
        ...
        "center" == t &&
          ...
          "bottom" == t && e.css({ bottom: 0 + v + "px" }),
          "top" == t && e.css({ top: 0 + v + "px" }),
          "center" == u &&
            e.css({
              left: "50%",
              marginLeft: i + w - Math.round(e.innerWidth() / 2) + "px",
            }),
          "left" == u && e.css({ left: 0 + w + i + "px" }),
          "right" == u && e.css({ right: 0 + w - i + "px" });
      },
      q = function (c) {
        var d = c.container;
        (c.beforli = c.next - 1),
        ...
        var i = c.arr,
          ...
          q = c.latit;
        if (
          (e.data("title") != b && p.html(e.data("title")),
          f.data("title") != b && q.html(f.data("title")),
          j.hasClass("itishovered") &&
            j.width(p.outerWidth(!0) + parseInt(j.css("minWidth"), 0)),
          k.hasClass("itishovered") &&
            k.width(q.outerWidth(!0) + parseInt(k.css("minWidth"), 0)),
          ...
          if ((i.addClass("hashoveralready"), W())) {
            ...
            i.hover(
              function () {
                ...
                a(window).width() > 767 &&
                  b.width(c.outerWidth(!0) + parseInt(b.css("minWidth"), 0)),
                  b.addClass("itishovered");
              },
              function () {
                var b = a(this);
                b.find(".tp-arr-titleholder"),
                  b.css({ width: parseInt(b.css("minWidth"), 0) }),
        ...
        f.data("thumb") != b && (g = f.data("thumb")),
          ...
          i.hasClass("preview4")
            ? (n.css({ backgroundImage: "url(" + h + ")" }),
              o.css({ backgroundImage: "url(" + g + ")" }),
              ...
              punchgs.TweenLite.fromTo(
                ...
                { force3D: punchgs.force3d, x: 0 },
                {
                  ...
                  delay: 1,
                  onComplete: function () {
                    m.css({ backgroundImage: "url(" + g + ")" }),
                      punchgs.TweenLite.set(o, { x: 0 });
                  },
                }
              ),
              punchgs.TweenLite.fromTo(
            ...
            : (punchgs.TweenLite.to(l, 0.5, {
              ...
              punchgs.TweenLite.to(m, 0.5, {
                autoAlpha: 0,
                onComplete: function () {
                  punchgs.TweenLite.to(l, 0.5, { autoAlpha: 1, delay: 0.2 }),
                    punchgs.TweenLite.to(m, 0.5, { autoAlpha: 1, delay: 0.2 });
                },
              })),
          j.hasClass("preview4") &&
            !j.hasClass("hashoveralready") &&
            (j.addClass("hashoveralready"),
            j.hover(
              function () {
      ...
      r = function (c, d) {
        if (
          ...
          d.bh < d.bw && (d.bw = d.bh),
          d.bw < d.bh && (d.bh = d.bw),
          d.bh > 1 && ((d.bw = 1), (d.bh = 1)),
          d.bw > 1 && ((d.bw = 1), (d.bh = 1)),
          ...
          if (d.fullScreenOffsetContainer != b) {
            ...
            try {
              d.fullScreenOffset.split("%").length > 1 &&
              d.fullScreenOffset != b &&
              d.fullScreenOffset.length > 0
                ? (f -=
                    (a(window).height() * parseInt(d.fullScreenOffset, 0)) / 100)
                : d.fullScreenOffset != b &&
                  d.fullScreenOffset.length > 0 &&
                  (f -= parseInt(d.fullScreenOffset, 0)),
                f < d.minFullScreenHeight && (f = d.minFullScreenHeight);
            } catch (h) {}
          }
        ...
        (d.slotw = Math.ceil(d.width / d.slots)),
          (d.sloth =
            "on" == d.fullScreen
              ? Math.ceil(a(window).height() / d.slots)
              : Math.ceil(d.height / d.slots)),
        ...
        c.find(".tp-caption").each(function () {
          ...
          c.find(">ul:first >li").each(function () {
            ...
            if (
              ...
              i != b &&
                "next" != i &&
                "prev" != i &&
                c.find(">ul:first-child >li").each(function () {
                  var b = a(this);
          ...
          c.find(">ul:first >li >img").each(function (c) {
            ...
            e.addClass("defaultimg"),
              ...
              "on" == d.panZoomDisableOnMobile &&
                W() &&
                (e.data("kenburns", "off"), e.data("bgfit", "cover")),
              e.wrap(
              ...
              "none" != d.dottedOverlay &&
                ...
                e
                  .closest(".slotholder")
                  .append(
                    '<div class="tp-dottedoverlay ' + d.dottedOverlay + '"></div>'
                  );
            var f = e.attr("src"),
      ...
      t = function (a, c, d, e) {
        ...
        g.data("currotate") != b && (j = g.data("currotate")),
          g.data("curscale") != b && "box" == e
            ? (h = 100 * g.data("curscale"))
            : g.data("curscale") != b && (h = g.data("curscale")),
          r(g, c);
        var k = g.data("src"),
        ...
        switch (e) {
          case "box":
            ...
            var y = 0,
              z = 0;
            "on" == f.data("kenburns") &&
              ((s = h), s.toString().length < 4 && (s = X(s, f, c)));
      ...
      u = function (a, b) {
        if (i(8)) {
          ...
          c.width(),
            c.height(),
            b.startwidth / b.startheight < a.data("owidth") / a.data("oheight")
              ? c.css({ width: "auto", height: "100%" })
              : c.css({ width: "100%", height: "auto" }),
            setTimeout(function () {
              var d = c.width(),
                e = c.height(),
                f = a.data("bgposition");
              "center center" == f &&
                ...
                ("center top" == f || "top center" == f) &&
                  c.css({
                    position: "absolute",
                    top: "0px",
                    left: b.width / 2 - d / 2 + "px",
                  }),
                ("center bottom" == f || "bottom center" == f) &&
                  c.css({
                    position: "absolute",
                    bottom: "0px",
                    left: b.width / 2 - d / 2 + "px",
                  }),
                ("right top" == f || "top right" == f) &&
                  c.css({ position: "absolute", top: "0px", right: "0px" }),
                ("right bottom" == f || "bottom right" == f) &&
                  c.css({ position: "absolute", bottom: "0px", right: "0px" }),
                ("right center" == f || "center right" == f) &&
                  c.css({
                    position: "absolute",
                    top: b.height / 2 - e / 2 + "px",
                    right: "0px",
                  }),
                ("left bottom" == f || "bottom left" == f) &&
                  c.css({ position: "absolute", bottom: "0px", left: "0px" }),
                ("left center" == f || "center left" == f) &&
                  c.css({
                    position: "absolute",
                    top: b.height / 2 - e / 2 + "px",
                    left: "0px",
        ...
        c.find("img, .defaultimg").each(function () {
          ...
          if (f != e.attr("src") && 3 > d && f != b && "undefined" != f) {
            ...
            (g.onload = function () {
              ...
              (g.src =
                e.attr("src") != b && "undefined" != e.attr("src")
                  ? e.attr("src")
                  : e.data("src")),
              g.complete &&
                (e.hasClass("defaultimg") && x(e, g), e.data("lazydone", 1));
      ...
      z = function (a, c) {
        ...
        (c.bannertimeronpause = !0),
          ...
          (c.cd = 0),
          g.data("lazyload") != b &&
          "undefined" != g.data("lazyload") &&
          1 != g.data("lazydone")
            ? (i(8)
                ? g.attr("src", f.find(".defaultimg").data("lazyload"))
                : g.css({
                    backgroundImage:
                      'url("' + f.find(".defaultimg").data("lazyload") + '")',
                  }),
              g.data("src", f.find(".defaultimg").data("lazyload")),
              g.data("lazydone", 0),
              g.data("orgw", 0),
              f.data("loadeddone", 1),
              a.find(".tp-loader").css({ display: "block" }),
              y(
      ...
      B = function (a, c) {
        ...
        var g = d.find(".slotholder"),
          h = f.find(".slotholder");
        ("on" == h.data("kenburns") || "on" == g.data("kenburns")) &&
          (_(a, c), a.find(".kenburnimg").remove()),
          f.data("delay") != b
            ? ((c.cd = 0), (c.delay = f.data("delay")))
            : (c.delay = c.origcd),
          1 == c.firststart && punchgs.TweenLite.set(d, { autoAlpha: 0 }),
          punchgs.TweenLite.set(d, { zIndex: 18 }),
      ...
      C = function (c, d, e, f, g, h) {
        function x() {
          a.each(o, function (a, b) {
            (b[0] == m || b[8] == m) && ((j = b[1]), (n = b[2]), (r = s)),
              (s += 1);
          });
        }
        "prepared" == e.data("differentissplayed") &&
          (e.data("differentissplayed", "done"),
          e.data("transition", e.data("savedtransition")),
          e.data("slotamount", e.data("savedslotamount")),
          e.data("masterspeed", e.data("savedmasterspeed"))),
          e.data("fstransition") != b &&
            "done" != e.data("differentissplayed") &&
            (e.data("savedtransition", e.data("transition")),
        ...
        "on" == e.data("randomtransition")
          ? (l = Math.round(Math.random() * k.length))
          : (l += 1),
          l == k.length && (l = 0),
          e.data("nexttransid", l);
        var m = k[l];
        d.ie &&
          ("boxfade" == m && (m = "boxslide"),
        ...
        "scroll" == d.parallax &&
          ...
          "slidehorizontal" == m &&
            ((m = "slideleft"), 1 == d.leftarrowpressed && (m = "slideright")),
          "slidevertical" == m &&
            ((m = "slideup"), 1 == d.leftarrowpressed && (m = "slidedown")),
          "parallaxhorizontal" == m &&
            ((m = "parallaxtoleft"),
        ...
        "on" == h.data("kenburns") &&
          ...
          Y(c, d, !0, !0)),
          "random" == m &&
            ((m = Math.round(Math.random() * o.length - 1)),
            m > o.length - 1 && (m = o.length - 1)),
          "random-static" == m &&
            ((m = Math.round(Math.random() * p.length - 1)),
            m > p.length - 1 && (m = p.length - 1),
            (m = p[m])),
          "random-premium" == m &&
            ((m = Math.round(Math.random() * q.length - 1)),
        ...
        (1 == d.leftarrowpressed || d.act > d.next) && (y = 1),
          ...
          0 > j && (j = 0);
        var z = 300;
        e.data("masterspeed") != b &&
          e.data("masterspeed") > 99 &&
          e.data("masterspeed") < d.delay &&
          (z = e.data("masterspeed")),
          e.data("masterspeed") != b &&
            e.data("masterspeed") > d.delay &&
            (z = d.delay),
          (u = o[r]),
          c
            ...
            .each(function () {
              ...
              b.removeClass("selected"),
                ("withbullet" == d.navigationArrows ||
                  "nexttobullets" == d.navigationArrows) &&
                  (c = b.index() - 1),
        ...
        if (
          (A.add(punchgs.TweenLite.set(h.find(".defaultimg"), { opacity: 0 })),
          A.pause(),
          e.data("slotamount") == b || e.data("slotamount") < 1
            ? ((d.slots = Math.round(12 * Math.random() + 4)),
              "boxslide" == m
                ? (d.slots = Math.round(6 * Math.random() + 3))
                : "flyin" == m && (d.slots = Math.round(4 * Math.random() + 1)))
            : (d.slots = e.data("slotamount")),
          (d.rotate =
            e.data("rotate") == b
              ? 0
              : 999 == e.data("rotate")
          ...
          h.find(".slotslide").each(function (b) {
            ...
            (C += 1),
              C == B && (C = 0),
              A.add(
                punchgs.TweenLite.from(c, z / 600, {
                  opacity: 0,
                  top: 0 - d.sloth,
                  left: 0 - d.slotw,
                  rotation: d.rotate,
        ...
        if (1 == j) {
          ...
          h.find(".slotslide").each(function (b) {
            ...
            e + f > E && ((E = f + f), (F = b)),
              A.add(
                punchgs.TweenLite.from(c, e / 1e3, {
                  autoAlpha: 0,
                  force3D: "auto",
                  rotation: d.rotate,
        ...
        if (2 == j) {
          ...
          g.find(".slotslide").each(function () {
            ...
            h.find(".slotslide").each(function () {
              var b = a(this);
              G.add(
                punchgs.TweenLite.from(b, z / 1e3, {
                  left: 0 - d.slotw,
                  force3D: "auto",
                  rotation: d.rotate,
                }),
        ...
        if (6 == j) {
          ...
          setTimeout(function () {
            ...
            g.find(".slotslide").each(function (b) {
              ...
              G.add(
                punchgs.TweenLite.to(c, (z + e) / 1e3, {
                  top: 0 + d.height,
                  opacity: 1,
                  force3D: "auto",
                  rotation: d.rotate,
            ...
            h.find(".slotslide").each(function (b) {
              ...
              G.add(
                punchgs.TweenLite.from(c, (z + e) / 1e3, {
                  top: 0 - d.height,
                  opacity: 1,
                  force3D: "auto",
                  rotation: d.rotate,
        ...
        if (11 == j || 26 == j) {
          ...
          26 == j && (z = 0),
            h.find(".slotslide").each(function () {
              var c = a(this);
              A.add(
                punchgs.TweenLite.from(c, z / 1e3, {
                  autoAlpha: 0,
                  force3D: "auto",
                  ease: punchgs.Power2.easeInOut,
                }),
        ...
        if (12 == j || 13 == j || 14 == j || 15 == j) {
          ...
          var K = d.width,
            ...
            V = z / 1e3,
            W = V;
          ("on" == d.fullWidth || "on" == d.fullScreen) &&
            ((K = N.width()), (M = N.height())),
            12 == j
              ? (O = K)
              : 15 == j
              ? (O = 0 - K)
            ...
            6 == n && (R = 1.4),
            (5 == n || 6 == n) &&
              ((S = 1.4), (Q = 0), (K = 0), (M = 0), (O = 0), (P = 0)),
            6 == n && (S = 0.6),
            A.add(
              punchgs.TweenLite.from(N, V, {
                left: O,
                top: P,
                scale: S,
                opacity: Q,
          ...
          if (((4 == n || 5 == n) && ((K = 0), (M = 0)), 1 != n))
            switch (j) {
              case 12:
                A.add(
                  punchgs.TweenLite.to(Z, W, {
                    left: 0 - K + "px",
                    force3D: "auto",
                    scale: R,
                    opacity: Q,
        ...
        if (16 == j) {
          var G = new punchgs.TimelineLite();
          A.add(
            punchgs.TweenLite.set(f, { position: "absolute", "z-index": 20 }),
            0
          ),
            A.add(
              punchgs.TweenLite.set(e, { position: "absolute", "z-index": 15 }),
              0
            ),
            f.wrapInner(
          ...
          "on" == d.autoHeight && (M = c.height()),
            ...
            A.add(
              punchgs.TweenLite.set(f.find(".tp-half-two"), {
                width: K,
                height: M,
                overflow: "hidden",
                zIndex: 15,
            ...
            A.add(
              punchgs.TweenLite.set(f.find(".tp-half-one"), {
                width: K,
                height: M / 2,
                overflow: "visible",
                zIndex: 10,
          ...
          var _ = (f.find(".defaultimg"), Math.round(20 * Math.random() - 10)),
            ...
            db = 0.4 * Math.random() - 0.2,
            eb = 0.4 * Math.random() - 0.2,
            fb = 1 * Math.random() + 1,
            gb = 1 * Math.random() + 1,
            hb = 0.3 * Math.random() + 0.3;
          A.add(
            punchgs.TweenLite.set(f.find(".tp-half-one"), { overflow: "hidden" }),
            0
          ),
            A.add(
              punchgs.TweenLite.fromTo(
                ...
                },
                {
                  ...
                  onComplete: function () {
                    punchgs.TweenLite.set(f, {
                      ...
                      f.find(".tp-half-one").length > 0 &&
                        (f.find(".tp-half-one .defaultimg").unwrap(),
        ...
        if (
          ...
          A.add(punchgs.TweenLite.set(f, { zIndex: 20 }), 0),
            A.add(punchgs.TweenLite.set(e, { zIndex: 20 }), 0),
            setTimeout(function () {
              g.find(".defaultimg").css({ opacity: 0 });
            }, 100);
          ...
          h.find(".slotslide").each(function (b) {
            ...
            A.add(
              punchgs.TweenLite.fromTo(
                ...
                { left: 0, delay: (50 * b) / 1e3, ease: punchgs.Power2.easeInOut }
              ),
              0
            ),
              A.add(
          ...
          h.find(".slotslide").each(function () {
            ...
            1 != y
              ? ((mb = -d.width),
                (kb = 90),
                25 == j
                  ? ((lb = "center top 0"), (nb = -kb), (kb = d.rotate))
                  : ((lb = "left center 0"), (nb = d.rotate)))
              : ((mb = d.width),
                (kb = -90),
                25 == j
                  ? ((lb = "center bottom 0"), (nb = -kb), (kb = d.rotate))
                  : ((lb = "right center 0"), (nb = d.rotate))),
            g.find(".slotslide").each(function () {
              var c = a(this);
              A.add(
                punchgs.TweenLite.fromTo(
        ...
        A.pause(),
          L(e, d, null, A),
          punchgs.TweenLite.to(e, 0.001, { autoAlpha: 1 });
        var pb = {};
      ...
      D = function (a, b, c, d, e, f, g) {
        punchgs.TweenLite.to(c.find(".defaultimg"), 0.001, {
          autoAlpha: 1,
          onComplete: function () {
            v(a, b, e);
          },
          ...
          a
            .find(".current-sr-slide-visible")
            .removeClass("current-sr-slide-visible"),
          e.addClass("current-sr-slide-visible"),
          ("scroll" == b.parallax ||
            "scroll+mouse" == b.parallax ||
            "mouse+scroll" == b.parallax) &&
            bb(a, b),
          g.clear();
      },
      E = function (b) {
          ...
          d.addEvent("ready", function () {
            c && d.api("play"),
              ...
              g.find(".tp-thumb-image").click(function () {
                punchgs.TweenLite.to(a(this), 0.3, {
                  autoAlpha: 0,
                  force3D: "auto",
                  ease: punchgs.Power3.easeInOut,
                }),
          ...
          a.each(d, function (a, c) {
            ...
            "rotationX" == d && (b.rotationX = parseInt(e, 0)),
              ...
              "transformPerspective" == d &&
                (b.transformPerspective = parseInt(e, 0));
          }),
          b
        );
      },
          ...
          m.each(function (c) {
            ...
            if (m.hasClass("tp-static-layer")) {
              ...
              (-1 == n || "-1" == n) && m.data("startslide", 0),
                ...
                0 == n &&
                  o == d.slideamount - 1 &&
                  m.data("endslide", d.slideamount + 1),
                (n = m.data("startslide")),
                (o = m.data("endslide")),
                m.hasClass("tp-is-shown")
                  ? (j = o == d.next || n > d.next || o < d.next ? 2 : 0)
                  : (n <= d.next && o >= d.next) || n == d.next || o == d.next
                  ? (m.addClass("tp-is-shown"), (j = 1))
                  : (j = 0);
            }
            ...
            d.bh,
              "on" == d.fullScreen &&
                (l = d.height / 2 - (d.startheight * d.bh) / 2),
              ("on" == d.autoHeight || (d.minHeight != b && d.minHeight > 0)) &&
                (l = d.container.height() / 2 - (d.startheight * d.bh) / 2),
              0 > l && (l = 0);
            var r = 0;
            if (
              (d.width < d.hideCaptionAtLimit && "on" == m.data("captionhidden")
                ? (m.addClass("tp-hidden-caption"), (r = 1))
                : d.width < d.hideAllCaptionAtLimit ||
                  d.width < d.hideAllCaptionAtLilmit
                ? (m.addClass("tp-hidden-caption"), (r = 1))
                : m.removeClass("tp-hidden-caption"),
              0 == r)
            ) {
              if (
                (m.data("linktoslide") == b ||
                  m.hasClass("hasclicklistener") ||
                  (m.addClass("hasclicklistener"),
                  m.css({ cursor: "pointer" }),
                  "no" != m.data("linktoslide") &&
                    m.click(function () {
                      var b = a(this),
                        c = b.data("linktoslide");
                      "next" != c && "prev" != c
                        ? (d.container.data("showus", c),
                          d.container.parent().find(".tp-rightarrow").click())
                        : "next" == c
                        ? d.container.parent().find(".tp-rightarrow").click()
                        : "prev" == c &&
                          d.container.parent().find(".tp-leftarrow").click();
                    })),
                0 > k && (k = 0),
                m.hasClass("tp-videolayer") ||
                  m.find("iframe").length > 0 ||
                  m.find("video").length > 0)
              ) {
                var s = "iframe" + Math.round(1e5 * Math.random() + 1),
                  ...
                  D = "http",
                  L =
                    "loop" == m.data("videoloop")
                      ? "loop"
                      : "loopandnoslidestop" == m.data("videoloop")
                      ? "loop"
                      : "";
                if (
                  (m.data("thumbimage") != b &&
                    m.data("videoposter") == b &&
                    m.data("videoposter", m.data("thumbimage")),
                  w != b &&
                    String(w).length > 1 &&
                    0 == m.find("iframe").length &&
                    ((D = "https"),
                    "none" == C &&
                      ((v = v.replace("controls=1", "controls=0")),
                      -1 == v.toLowerCase().indexOf("controls") &&
                        (v += "&controls=0")),
                    m.append(
                  ...
                  x != b &&
                    String(x).length > 1 &&
                    0 == m.find("iframe").length &&
                    ("https:" === location.protocol && (D = "https"),
                    m.append(
                      '<iframe style="visible:hidden" src="' +
                        D +
                  ...
                  m.data("videoposter") != b &&
                    m.data("videoposter") != b &&
                    (N = N + 'poster="' + m.data("videoposter") + '">'),
                    A != b &&
                      "firefox" == M().toLowerCase() &&
                      (N = N + '<source src="' + A + '" type="video/webm" />'),
                    z != b &&
                      (N = N + '<source src="' + z + '" type="video/mp4" />'),
                    B != b &&
                      (N = N + '<source src="' + B + '" type="video/ogg" />'),
                    (N += "</video>"),
                    m.append(N),
                    "controls" == C &&
                      m.append(
                ...
                var R = !1;
                (1 == m.data("autoplayonlyfirsttime") ||
                  "true" == m.data("autoplayonlyfirsttime") ||
                  1 == m.data("autoplay")) &&
                  (m.data("autoplay", !0), (R = !0)),
                  m.find("iframe").each(function () {
                    ...
                    if (
                      ...
                      m.data("videoposter") != b &&
                        m.data("videoposter").length > 2 &&
                        1 != m.data("autoplay") &&
                        !f &&
                        (0 == m.find(".tp-thumb-image").length
                          ? m.append(
                          ...
                          : punchgs.TweenLite.set(m.find(".tp-thumb-image"), {
                              autoAlpha: 1,
                            })),
                                  ...
                                  events: {
                                    ...
                                    onReady: function (c) {
                                      var d = c.target.getVideoEmbedCode(),
                                        e = a(
                                          "#" + d.split('id="')[1].split('"')[0]
                                        ),
                                        f = e.closest(".tp-caption"),
                                        g = f.data("videorate");
                                      f.data("videostart"),
                                        g != b &&
                                          c.target.setPlaybackRate(parseFloat(g)),
                                        ((!W() && 1 == f.data("autoplay")) ||
                                          R) &&
                                          f.data(
                                            "timerplay",
                      ...
                      if (c.hasClass("HasListener")) {
                        ...
                        var h = m.find("iframe")[0],
                          q = setInterval(function () {
                            $f != b &&
                              typeof $f(s).api != b &&
                              "undefined" != typeof $f(s).api &&
                              ($f(h).addEvent("ready", function () {
                                G(s, R);
                              }),
                              clearInterval(q));
                          }, 100);
                  ...
                  ((W() && 1 == m.data("disablevideoonmobile")) || i(8)) &&
                    m.find("video").remove(),
                  m.find("video").length > 0 &&
                    m.find("video").each(function () {
                      var e = this,
                        f = a(this);
                      f.parent().hasClass("html5vid") ||
                        f.wrap(
                            ...
                            if (
                              ...
                              if (
                                ...
                                g.addClass("HasListener"),
                                  "none" != m.data("dottedoverlay") &&
                                    m.data("dottedoverlay") != b &&
                                    1 != m.find(".tp-dottedoverlay").length &&
                                    g.append(
                                      '<div class="tp-dottedoverlay ' +
                                        m.data("dottedoverlay") +
                                        '"></div>'
                                    ),
                                  f.attr("control") == b &&
                                    (0 ==
                                      g.find(".tp-video-play-button").length &&
                                      g.append(
                                ...
                                a != b &&
                                  ...
                                  F(c, "click", function () {
                                    0 == e.muted
                                      ? ((e.muted = !0), (c.innerHTML = "Unmute"))
                                      : ((e.muted = !1), (c.innerHTML = "Mute"));
                                  }),
                                  F(h, "click", function () {
                                    e.requestFullscreen
                                      ? e.requestFullscreen()
                              ...
                              var l = 16 / 9;
                              if (
                                ("4:3" == m.data("aspectratio") && (l = 4 / 3),
                                g.data("mediaAspect", l),
                                1 ==
                                  g.closest(".tp-caption").data("forcecover") &&
                                  (H(g, d.container),
                                  g.addClass("fullcoveredvideo")),
                                f.css({ display: "block" }),
                                (d.nextslideatend = m.data("nextslideatend")),
                                (1 == m.data("autoplay") || 1 == k) &&
                                  ("loopandnoslidestop" == m.data("videoloop")
                                    ? ((d.videoplaying = !1),
                                      d.container.trigger("starttimer"),
                                      d.container.trigger(
                                  ...
                                  "on" != m.data("forcerewind") ||
                                    g.hasClass("videoisplaying") ||
                                    (e.currentTime > 0 && (e.currentTime = 0)),
                                  "mute" == m.data("volume") && (e.muted = !0),
                                  g.data(
                                    "timerplay",
                                    setTimeout(function () {
                                ...
                                g.data("ww") == b &&
                                  g.data("ww", f.attr("width")),
                                g.data("hh") == b &&
                                  g.data("hh", f.attr("height")),
                                !m.hasClass("fullscreenvideo") &&
                                  1 == m.data("forcecover"))
                              )
                                try {
              ...
              if (m.find("img").length > 0) {
                var X = m.find("img");
                0 == X.width() && X.css({ width: "auto" }),
                  0 == X.height() && X.css({ height: "auto" }),
                ...
                var Y = m.data("ww"),
                  ...
                  _ = m;
                _.data("fsize") == b &&
                  _.data("fsize", parseInt(_.css("font-size"), 0) || 0),
                  _.data("pt") == b &&
                    _.data("pt", parseInt(_.css("paddingTop"), 0) || 0),
                  _.data("pb") == b &&
                    _.data("pb", parseInt(_.css("paddingBottom"), 0) || 0),
                  _.data("pl") == b &&
                    _.data("pl", parseInt(_.css("paddingLeft"), 0) || 0),
                  _.data("pr") == b &&
                    _.data("pr", parseInt(_.css("paddingRight"), 0) || 0),
                  _.data("mt") == b &&
                    _.data("mt", parseInt(_.css("marginTop"), 0) || 0),
                  _.data("mb") == b &&
                    _.data("mb", parseInt(_.css("marginBottom"), 0) || 0),
                  _.data("ml") == b &&
                    _.data("ml", parseInt(_.css("marginLeft"), 0) || 0),
                  _.data("mr") == b &&
                    _.data("mr", parseInt(_.css("marginRight"), 0) || 0),
                  _.data("bt") == b &&
                    _.data("bt", parseInt(_.css("borderTop"), 0) || 0),
                  _.data("bb") == b &&
                    _.data("bb", parseInt(_.css("borderBottom"), 0) || 0),
                  _.data("bl") == b &&
                    _.data("bl", parseInt(_.css("borderLeft"), 0) || 0),
                  _.data("br") == b &&
                    _.data("br", parseInt(_.css("borderRight"), 0) || 0),
                  _.data("lh") == b &&
                    _.data("lh", parseInt(_.css("lineHeight"), 0) || 0),
                  "auto" == _.data("lh") && _.data("lh", _.data("fsize") + 4);
                var ab = d.width,
                  bb = d.height;
                if (
                  (ab > d.startwidth && (ab = d.startwidth),
                ...
                0 == $
                  ? (X.width(Y * d.bw), X.height(Z * d.bh))
                  : 1 == m.data("forcecover") ||
                    m.hasClass("fullscreenvideo") ||
                    (X.width(Y * d.bw), X.height(Z * d.bh)),
                  (U = X.width()),
                ...
                m.find(".tp-resizeme, .tp-resizeme *").each(function () {
                  ...
                  m.hasClass("tp-resizeme") &&
                    m.find("*").each(function () {
                      O(a(this), d);
                    }),
                  O(m, d),
                  (V = m.outerHeight(!0)),
              ...
              "on" == d.fullScreenAlignForce && ((k = 0), (l = 0)),
              ...
              "on" == d.fullScreenAlignForce &&
                ((hb = d.container.width()), (ib = d.container.height())),
                ("center" == m.data("x") || "center" == m.data("xcenter")) &&
                  (m.data("xcenter", "center"),
                  m.data("x", hb / 2 - m.outerWidth(!0) / 2 + gb)),
                ("left" == m.data("x") || "left" == m.data("xleft")) &&
                  (m.data("xleft", "left"), m.data("x", 0 / p + gb)),
                ("right" == m.data("x") || "right" == m.data("xright")) &&
                  (m.data("xright", "right"),
                  m.data("x", (hb - m.outerWidth(!0) + gb) / p)),
                ("center" == m.data("y") || "center" == m.data("ycenter")) &&
                  (m.data("ycenter", "center"),
                  m.data("y", ib / 2 - m.outerHeight(!0) / 2 + fb)),
                ("top" == m.data("y") || "top" == m.data("ytop")) &&
                  (m.data("ytop", "top"), m.data("y", 0 / d.bh + fb)),
                ("bottom" == m.data("y") || "bottom" == m.data("ybottom")) &&
                  (m.data("ybottom", "bottom"),
              ...
              if (
                ...
                m.data("timeline") == b ||
                  f ||
                  (2 != j && m.data("timeline").gotoAndPlay(0), (f = !0)),
                !f)
              ) {
                m.data("timeline") != b;
                ...
                m.data("mySplitText") != b && m.data("mySplitText").revert(),
                  ("chars" == m.data("splitin") ||
                    "words" == m.data("splitin") ||
                    "lines" == m.data("splitin") ||
                    "chars" == m.data("splitout") ||
                    "words" == m.data("splitout") ||
                    "lines" == m.data("splitout")) &&
                    (m.find("a").length > 0
                      ? m.data(
                          "mySplitText",
                          new punchgs.SplitText(m.find("a"), {
                      ...
                      : m.find(".tp-layer-inner-rotation").length > 0
                      ? m.data(
                          "mySplitText",
                          new punchgs.SplitText(
                            m.find(".tp-layer-inner-rotation"),
                            {
                              type: "lines,words,chars",
                              charsClass: "tp-splitted",
                              wordsClass: "tp-splitted",
                    ...
                    m.addClass("splitted")),
                  "chars" == m.data("splitin") &&
                    (pb = m.data("mySplitText").chars),
                  "words" == m.data("splitin") &&
                    (pb = m.data("mySplitText").words),
                  "lines" == m.data("splitin") &&
                    (pb = m.data("mySplitText").lines);
                var qb = I(),
                  rb = I();
                m.data("repeat") != b && (repeatV = m.data("repeat")),
                  m.data("yoyo") != b && (yoyoV = m.data("yoyo")),
                  m.data("repeatdelay") != b &&
                    (repeatdelayV = m.data("repeatdelay"));
                var sb = m.attr("class");
                sb.match("customin")
                  ? (qb = J(qb, m.data("customin")))
                  : sb.match("randomrotate")
                  ...
                  : sb.match("lfr") || sb.match("skewfromright")
                  ? (qb.x = 15 + d.width)
                  : sb.match("lfl") || sb.match("skewfromleft")
                  ? (qb.x = -15 - U)
                  : sb.match("sfl") || sb.match("skewfromleftshort")
                  ? (qb.x = -50)
                  : sb.match("sfr") || sb.match("skewfromrightshort")
                  ? (qb.x = 50)
                  : sb.match("lft")
                  ? (qb.y = -25 - V)
                  : sb.match("lfb")
                  ...
                  : sb.match("sft")
                  ? (qb.y = -50)
                  : sb.match("sfb") && (qb.y = 50),
                  sb.match("skewfromright") || m.hasClass("skewfromrightshort")
                    ? (qb.skewX = -85)
                    : (sb.match("skewfromleft") ||
                        m.hasClass("skewfromleftshort")) &&
                      (qb.skewX = 85),
                  (sb.match("fade") ||
                    sb.match("sft") ||
                    sb.match("sfl") ||
                    sb.match("sfb") ||
                    sb.match("skewfromleftshort") ||
                    sb.match("sfr") ||
                    sb.match("skewfromrightshort")) &&
                    (qb.opacity = 0),
                  ...
                  if (sb.match("customin"))
                    ...
                    for (var c = 0; c < pb.length; c++) {
                      ...
                      a.extend(vb, qb),
                        ...
                        ob.append(
                          punchgs.TweenLite.fromTo(pb[c], lb, vb, wb),
                          "frame0"
                        );
                    }
                  else ob.add(ub.staggerFromTo(pb, lb, qb, rb, tb), "frame0");
                if (
                  (m.data("timeline", ob), new Array(), m.data("frames") != b)
                ) {
                ...
                (ob = m.data("timeline")),
                  m.data("end") == b || (-1 != j && 2 != j)
                    ? -1 == j || 2 == j
                      ? T(m, d, 999999, qb, "frame99", p)
                      : T(m, d, 999999, qb, "frame99", p)
                    : T(m, d, m.data("end") / 1e3, qb, "frame99", p),
                  (ob = m.data("timeline")),
                  m.data("timeline", ob),
                  P(m, p),
                  ob.resume();
              ...
              a.each(Ab, function (a, c) {
                if (c.vars.data != b) {
                  ...
                  if (1 != c.progress() && 0 != c.progress())
                    ...
                    1 == c.progress() &&
                      punchgs.TweenLite.set(c.target, { x: d, y: e });
                }
              });
            }
          });
        var o = a("body")
          .find("#" + d.container.attr("id"))
          .find(".tp-bannertimer");
        o.data("opt", d),
          f != b &&
            setTimeout(function () {
      ...
      O = function (a, c) {
        a.data("fsize") == b &&
          ...
          a.hasClass("tp-splitted") ||
            ...
            "none" != a.data("maxheight") &&
              a.css({ maxHeight: a.data("maxheight") * c.bh + "px" }),
            "none" != a.data("maxwidth") &&
              a.css({ maxWidth: a.data("maxwidth") * c.bw + "px" }));
      },
      P = function (c, d) {
        c.find(".rs-pendulum").each(function () {
          ...
          if (c.data("timeline") == b) {
            ...
            var e = c.data("startdeg") == b ? -20 : c.data("startdeg"),
              ...
              i =
                c.data("easing") == b ? punchgs.Power2.easeInOut : c.data("ease");
            (e *= d),
              (f *= d),
              c
                .data("timeline")
                .append(
                  new punchgs.TweenLite.fromTo(
                    c,
                    g,
                    { force3D: "auto", rotation: e, transformOrigin: h },
                    { rotation: f, ease: i }
                  )
                ),
              c.data("timeline").append(
                new punchgs.TweenLite.fromTo(
                  c,
                  g,
                  { force3D: "auto", rotation: f, transformOrigin: h },
                  {
                    rotation: e,
                    ease: i,
                    onComplete: function () {
              ...
              (speed = c.data("speed") == b ? 2 : c.data("speed")),
                ...
                c.data("timeline").append(
                  new punchgs.TweenLite.fromTo(
                    c,
                    speed,
                    { force3D: "auto", rotation: e, transformOrigin: origin },
                    {
                      rotation: f,
                      ease: easing,
                      onComplete: function () {
                ...
                new punchgs.TweenLite.fromTo(
                  ...
                  { a: 360 },
                  {
                    ...
                    onUpdate: function () {
                      ...
                      punchgs.TweenLite.to(i.element, 0.1, {
                        force3D: "auto",
                        x: Math.cos(a) * i.unit,
      ...
      Q = function (c) {
        c.find(".rs-pendulum, .rs-slideloop, .rs-pulse, .rs-wave").each(
          function () {
            var c = a(this);
            c.data("timeline") != b &&
              (c.data("timeline").pause(), c.data("timeline", null));
          }
        );
      },
      R = function (c, d) {
        ...
        return (
          ...
          f.each(function () {
            var f = -1,
              g = a(this);
            if (
              (g.hasClass("tp-static-layer") &&
                ((-1 == g.data("startslide") || "-1" == g.data("startslide")) &&
                  g.data("startslide", 0),
                (-1 == g.data("endslide") || "-1" == g.data("endslide")) &&
                  g.data("endslide", d.slideamount),
                g.hasClass("tp-is-shown")
                  ? g.data("startslide") > d.next || g.data("endslide") < d.next
                    ? ((f = 2), g.removeClass("tp-is-shown"))
                    : (f = 0)
                  : (f = 2)),
              0 != f)
            ) {
              if ((Q(g), g.find("iframe").length > 0)) {
                punchgs.TweenLite.to(g.find("iframe"), 0.2, { autoAlpha: 0 }),
      ...
      S = function (a, c, d, e, f) {
        var g = a.data("timeline"),
          ...
          i = a;
        "chars" == d.typ
          ? (i = a.data("mySplitText").chars)
          : "words" == d.typ
          ? (i = a.data("mySplitText").words)
          : "lines" == d.typ && (i = a.data("mySplitText").lines),
          (d.animation.ease = d.ease),
          d.animation.rotationZ != b &&
            (d.animation.rotation = d.animation.rotationZ),
      ...
      T = function (a, c, d, e, f, g) {
        ...
        if (
          ...
          l.match("ltr") ||
            ...
            l.match("stb") ||
            l.match("skewtoright") ||
            l.match("skewtorightshort") ||
            l.match("skewtoleft") ||
            l.match("skewtoleftshort") ||
            l.match("fadeout") ||
            l.match("randomrotateout"))
        ) {
          l.match("skewtoright") || l.match("skewtorightshort")
            ? (j.skewX = 35)
            : (l.match("skewtoleft") || l.match("skewtoleftshort")) &&
              (j.skewX = -35),
            l.match("ltr") || l.match("skewtoright")
              ? (j.x = c.width + 60)
              : l.match("ltl") || l.match("skewtoleft")
              ? (j.x = 0 - (c.width + 60))
              : l.match("ltt")
              ? (j.y = 0 - (c.height + 60))
              : l.match("ltb")
              ? (j.y = c.height + 60)
              : l.match("str") || l.match("skewtorightshort")
              ? ((j.x = 50), (j.opacity = 0))
              : l.match("stl") || l.match("skewtoleftshort")
              ? ((j.x = -50), (j.opacity = 0))
              : l.match("stt")
              ? ((j.y = -50), (j.opacity = 0))
              : l.match("stb")
              ? ((j.y = 50), (j.opacity = 0))
              : l.match("randomrotateout")
              ? ((j.x = Math.random() * c.width),
                (j.y = Math.random() * c.height),
                (j.scale = 2 * Math.random() + 0.3),
                (j.rotation = 360 * Math.random() - 180),
                (j.opacity = 0))
              : l.match("fadeout") && (j.opacity = 0),
            l.match("skewtorightshort")
              ? (j.x = 270)
              : l.match("skewtoleftshort") && (j.x = -270),
            (j.data = new Object()),
            (j.data.oldx = j.x),
            (j.data.oldy = j.y),
            (j.x = j.x * g),
          ...
          var m = a,
            m = a;
          "chars" == a.data("splitout")
            ? (m = a.data("mySplitText").chars)
            : "words" == a.data("splitout")
            ? (m = a.data("mySplitText").words)
            : "lines" == a.data("splitout") && (m = a.data("mySplitText").lines);
      ...
      V = function (c, d) {
        if (
          ...
          (d.loop = 0),
          (d.looptogo =
            d.stopAfterLoops != b && d.stopAfterLoops > -1
              ? d.stopAfterLoops
              : 9999999),
          (d.lastslidetoshow =
            d.stopAtSlide != b && d.stopAtSlide > -1 ? d.stopAtSlide : 999),
          (d.stopLoop = "off"),
          ...
          c.on("stoptimer", function () {
            ...
            c.on("starttimer", function () {
              1 != d.conthover &&
                1 != d.videoplaying &&
                d.width > d.hideSliderAtLimit &&
                1 != d.bannertimeronpause &&
                1 != d.overnav &&
                (("on" == d.stopLoop && d.next == d.lastslidetoshow - 1) ||
                1 == d.noloopanymore
                  ? (d.noloopanymore = 1)
                  : (e.css({ visibility: "visible" }), e.data("tween").resume())),
                "on" == d.hideTimerBar && e.css({ visibility: "hidden" });
            }),
          ...
          var f = function () {
            0 == a("body").find(c).length && (U(c, d), clearInterval(d.cdint)),
              c.trigger("revolution.slide.slideatend"),
              1 == c.data("conthover-changed") &&
                ((d.conthover = c.data("conthover")),
                c.data("conthover-changed", 0)),
              (d.act = d.next),
              (d.next = d.next + 1),
              d.next > c.find(">ul >li").length - 1 &&
                ((d.next = 0),
                (d.looptogo = d.looptogo - 1),
                d.looptogo <= 0 && (d.stopLoop = "on")),
              "on" == d.stopLoop && d.next == d.lastslidetoshow - 1
                ? (c.find(".tp-bannertimer").css({ visibility: "hidden" }),
                  c.trigger("revolution.slide.onstop"),
                  (d.noloopanymore = 1))
                : e.data("tween").restart(),
              z(c, d);
          };
          e.data(
            "tween",
      ...
      Z = function (a, b, c, d, e) {
        ...
        switch (
          ((f.w = e
            ? parseInt(c.split(" ")[1], 0) / 100
            : parseInt(c.split(" ")[0], 0) / 100),
          b)
        ) {
          case "left top":
          case "top left":
        ...
        e.find(".slotholder"),
          ...
          c.find(".defaultimg").each(function () {
            ...
            punchgs.TweenLite.killTweensOf(c, !1),
              punchgs.TweenLite.set(c, { scale: 1, rotationZ: 0 }),
              ...
              c != b &&
                c.data("kenburn img") != b &&
                c.data("kenburn img").length > 0 &&
                punchgs.TweenLite.set(c.data("kenburn img"), { autoAlpha: 0 });
          });
      },
      ab = function (b, c) {
        return W() && "on" == c.parallaxDisableOnMobile
          ? !1
                ...
                b.find(".rs-parallaxlevel-" + d).each(function () {
                  ...
                  b.wrap(
                    '<div style="position:absolute;top:0px;left:0px;width:100%;height:100%;z-index:' +
                      ...
                      c.parallaxLevels[d - 1] +
                      '"></div>'
                  );
                });
            }),
            ("mouse" == c.parallax ||
              "scroll+mouse" == c.parallax ||
              "mouse+scroll" == c.parallax) &&
                  ...
                  case "mousemove":
                    ...
                    e.find(".tp-parallax-container").each(function () {
                      var b = a(this),
                        ...
                        e = j * d,
                        f = k * d;
                      "scroll+mouse" == c.parallax || "mouse+scroll" == c.parallax
                        ? punchgs.TweenLite.to(b, 0.4, {
                            force3D: "auto",
                            x: e,
                            ease: punchgs.Power3.easeOut,
      ...
      cb = function (c, d) {
        var e = c.parent();
        ("thumb" == d.navigationType || "both" == d.navsecond) &&
          e.append(
      ...
      eb = function (a, b) {
        punchgs.TweenLite.to(a.find(".tp-thumbcontainer"), 0.2, {
          force3D: "auto",
          left: b,
          ease: punchgs.Power3.easeOut,
          overwrite: "auto",
